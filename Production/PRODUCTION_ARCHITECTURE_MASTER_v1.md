...
**Total codebase:** ~4,300 lines across 4 builders, with approximately 70% duplication in HTML scaffolding, CSS theming, localStorage patterns, credential reading, and Directus registration hooks.
...
1. **Image Reference Selection Tool** — No tool for browsing/selecting which master images to use per module. Current workflow: Kim browses Finder manually, tells Claude verbally which images to use.
...
- [ ] **Auto-register in Directus** after every successful build (no manual `--register` flag)
