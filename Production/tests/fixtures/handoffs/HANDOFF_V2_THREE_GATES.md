# Fixture — v2 handoff with three HALT gates

## What you're doing

Test fixture for DS-26 handoff parser (gate-count drift / template mismatch).
...
| 3 | Gate three | `Production/docs/example.md` | Met | HALT |
