...
_CRITICAL_NO_RAW_FCNTL = (
    _PROD / "tools" / "server_handlers" / "phases.py",
    _PROD / "tools" / "server_handlers" / "stitch_editor.py",
    _PROD / "tools" / "server_handlers" / "kling_o3.py",
    _PROD / "tools" / "production_server.py",
    _PROD / "tools" / "bg_export_stitcher_job_store.py",
    _PROD / "tools" / "stitch_bake_job_store.py",
    _PROD / "lib" / "state_repo.py",
    _PROD / "lib" / "directus.py",
)
