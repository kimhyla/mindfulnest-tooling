...
COST_OPENAI_END_FRAME = 0.20  # gpt-image-1 default vendor (LD-730); ~5x FLUX unit cost
COST_KLING_10S = 0.45
COST_LIPSYNC = 0.15
...
def ensure_avatar_still_dimensions(
    img_bytes: bytes,
    *,
    ...
    target_w = target_w or LIPSYNC_INPUT_WIDTH
    target_h = target_h or LIPSYNC_INPUT_HEIGHT
