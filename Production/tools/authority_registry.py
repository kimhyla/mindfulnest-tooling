...
CONCEPTS: tuple[AuthorityConcept, ...] = (
    ...
    AuthorityConcept(
        ...
        server_read="BeatGenScope",
        server_write="beatgen_scope",
        spec_doc="Production/docs/TECH_SPEC_BEATGEN_TRUTH_STACK_V1.md",
        notes="Layer 1 BeatGenScope not on every handler path yet.",
    ),
    AuthorityConcept(
    ...
    AuthorityConcept(
        ...
        notes="Writeback to partition/sidecar still has parallel paths (DISPLAY_ORDER debt).",
    ),
    AuthorityConcept(
    ...
    AuthorityConcept(
        ...
        notes="New bootstrap path; verify_event_stitch_job_bootstrap durability added.",
    ),
)
