...
CONCEPTS: tuple[AuthorityConcept, ...] = (
    ...
    AuthorityConcept(
        id="stitch_dry_hot_serve_playback",
        status="shipped",
        marker="STITCH_DRY_HOT_SERVE_PLAYBACK_V1",
        question="How does Stitcher bind dry/four-files composer video without Dropbox /files gray?",
        authority_shape="derived",
        client_module="storyboard-v2/src/utils/stitchDryHotServePlayback.ts",
        client_read="resolveStitchDrySlotHotPlaybackUrl",
        spec_doc="Production/docs/TECH_SPEC_STITCH_DRY_AUTHORITY_CLIENT_MIX_V1.md",
        notes="Bind only /api/media/playback/ after playback_resolve; never cold /files for dry slots.",
    ),
    AuthorityConcept(
        id="stitch_client_mix_sfx_prefetch",
        status="shipped",
        marker="STITCH_SFX_HOT_SERVE_PREFETCH_V1",
        question="When are default start/finish SFX cue bytes loaded for client-mix preview?",
        authority_shape="derived",
        client_module="storyboard-v2/src/audio/StitchSlotAudioMixEngine.ts",
        client_read="prefetchAllSfx",
        spec_doc="Production/docs/TECH_SPEC_STITCH_DRY_AUTHORITY_CLIENT_MIX_V1.md",
        notes="Attach prefetch + /files 503 retry; audit SFX_PREFETCH/SFX_LOAD_FAILED; play schedules from cache.",
    ),
    AuthorityConcept(
    ...
    AuthorityConcept(
        id="stitch_bake_slot_authority",
        status="shipped",
        marker="STITCH_BAKE_SLOT_AUTHORITY_V1",
        question="Which phase_b MP4 does module bake use?",
        authority_shape="disk",
        server_module="server_handlers/phases.py",
        server_read="validate_phase_b_stitch_slot_authority",
        server_write="stitch_upsert_event_slot",
