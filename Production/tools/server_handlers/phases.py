...
def handle_phase_suggest_script(h, body: dict)-> None:
    ...
    if phase == "a":
        ...
        user_prompt = (
            ...
            "## PACING FORMAT\n\n"
            "Write plain sentences only — no 'Cedric:' prefixes, no "
            "inline markup tags. The pipeline sends this text directly to "
            "ElevenLabs. Communicate pauses via ellipsis (…. or …..) "
            "within the sentence text, as in the few-shot example. "
            "End the script with '[fade to Rescue sustain]' on its own line.\n\n"
            "## FEW-SHOT EXAMPLE (approved M1 v9 script — canonical April 17 2026)\n\n"
            "This is Kim's final approved script. Match this sparseness exactly.\n"
            "Note: 'little one' not '{childName}' (universal audio per "
            "NO_RUNTIME_TTS_PERSONALIZATION_V1). 'ball of magic' not 'ball'.\n\n"
            "Ah, yes. ….. Welcome little one ...... I am your Magical Arts "
            "teacher. I've come to teach you …. the Magic Hands Spell.\n"
            "You'll make a real ball of energy … right between your hands.\n"
            "Step One. Rub your hands together. …. Getting warmer … warmer.\n"
            "Good.\n"
            "Now imagine a soccer-sized ball of magic in your hands.\n"
            "Can you feel it?\n"
            "Big breath in.\n"
            "As you breathe out, move your hands closer together.\n"
            "Good. Pull your hands farther apart.\n"
            "Now move your hands in and out, however you like. Play with "
            "the energy you feel between your hands.\n"
            "Keep breathing.\n"
            "What do you feel between your hands? … Pulling? … Tingling? "
            "… Warmth? …. Keep feeling.\n"
            "Can you move the energy around?\n"
            "It takes practice.\n"
            "That's the magic you have inside of you.\n"
            "Now, …. hold on to that magic.\n"
            "[fade to Rescue sustain]\n\n"
            "IMPORTANT: The above is the ONLY cue-marker format the pipeline "
            "supports. Write plain sentences; no 'Cedric:' prefixes. Pauses "
            "are communicated via ellipsis (…..) in the text, not inline tags. "
            "{{BELL_CUE}} / {{PAUSE:Xs}} markers are doc-only; do NOT emit them "
            "in the suggested script body.\n\n"
            "## TASK\n\n"
