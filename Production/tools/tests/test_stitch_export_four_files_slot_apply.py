...
from server_handlers.stitch_slot_playback import (  # noqa: E402
    ...
    STITCH_EXPORT_DRY_AUTHORITY_SLOT_APPLY_V1,
...
class AssertDryAuthoritySlotApplyTests(unittest.TestCase):
    def test_raises_when_slot_video_path_is_playback_bake(self) -> None:
            ...
            "jobs": {
                "Event_X_stitch": {
                    "slots": {
                        "intro": {
                            "video_path": play_rel,
                            "playback_recipe_version": STITCH_DRY_AUTHORITY_CLIENT_MIX_V1,
                        },
                    },
                },
            },
        ...
        artifacts = {
            "ok": True,
            "code": STITCH_DRY_AUTHORITY_CLIENT_MIX_V1,
            "video_path": play_rel,
        }
        ...
        self.assertIn(STITCH_EXPORT_DRY_AUTHORITY_SLOT_APPLY_V1, str(ctx.exception))
        self.assertIn("must be the dry concat", str(ctx.exception))
...
class ExportSourceGuards(unittest.TestCase):
    def test_kling_export_calls_slot_apply_assert(self) -> None:
        ...
        self.assertIn("verify_event_slot_dry_authority_export_applied", block)
    ...
    def test_phase_b_bake_preflight_validates_slot_authority_read_only(self) -> None:
        ...
        self.assertNotIn("verify_event_slot_dry_authority_export_applied", block)

    def test_upsert_event_slots_use_dry_authority_and_assert(self) -> None:
        playback = (TOOLS / "server_handlers" / "stitch_slot_playback.py").read_text(encoding="utf-8")
        self.assertIn("assert_dry_authority_export_slot_applied", playback)
        self.assertIn(STITCH_EXPORT_DRY_AUTHORITY_SLOT_APPLY_V1, playback)
        ...
        self.assertIn("persist_dry_authority_slot_export", block)
        self.assertNotIn("bake_and_persist_slot_playback_mp4", block)
