...
class PhaseAArloContractTests(unittest.TestCase):
    def test_deprecated_ids_coerce_to_v7(self) -> None:
        for old in (
    ...
    def test_canonical_v7_not_deprecated(self) -> None:
        self.assertEqual(PHASE_A_ARLO_BASE_CLIP_CANONICAL, "arlo_idle_wizard_desk_v7")
