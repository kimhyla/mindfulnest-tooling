...
export const STITCH_AMBIENT_LOOP_SIG_V1 =
  'STITCH_AMBIENT_LOOP_TRIM_V2:STITCH_AMBIENT_LOOP_XFADE_V1:STITCH_AMBIENT_FULL_PERIOD_TILE_V2:STITCH_AMBIENT_TILE_CONCAT_LOOP_V1:STITCH_AMBIENT_PERIOD_JUNCTION_XFADE_V1:STITCH_AMBIENT_BED_MIX_FADE_IN_V1:STITCH_AMBIENT_BED_SLOT_FADE_OUT_V1:2.500:0.500:0.750:period_junction_xfade_v1' as const;
