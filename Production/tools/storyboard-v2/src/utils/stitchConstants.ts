...
export const STITCH_AMBIENT_LOOP_SIG_V1 =
  'STITCH_AMBIENT_LOOP_TRIM_V2:STITCH_AMBIENT_LOOP_XFADE_V1:STITCH_AMBIENT_BED_MIX_FADE_IN_V1:STITCH_AMBIENT_BED_SLOT_FADE_OUT_V1:no_hard_aloop_v1' as const;
