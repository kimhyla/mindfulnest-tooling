...
grep -q 'STITCH_WAVEFORM_PEAKS_STABLE_ON_SFX_V1' "$WAVEFORM" || fail "missing STITCH_WAVEFORM_PEAKS_STABLE_ON_SFX_V1"
grep -q 'STITCH_SAVE_OPTIMISTIC_SLOTS_V1' "$ROOT/Production/tools/storyboard-v2/src/components/StitcherTab.tsx" || fail "missing STITCH_SAVE_OPTIMISTIC_SLOTS_V1"
grep -q 'STITCH_SFX_RANGE_INSTANT_V1' "$ROOT/Production/tools/storyboard-v2/src/components/StitcherTab.tsx" || fail "missing STITCH_SFX_RANGE_INSTANT_V1"
grep -q 'STITCH_SAVE_REFRESH_LOCAL_CUES_V1' "$ROOT/Production/tools/storyboard-v2/src/components/StitcherTab.tsx" || fail "missing STITCH_SAVE_REFRESH_LOCAL_CUES_V1"
