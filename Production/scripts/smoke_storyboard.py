#!/usr/bin/env python3
"""Smoke storyboard — V59 Phase 2 read-only smoke.

Per V59 spec §Phase 2 (LD-794). Probes storyboard-owned endpoints on
...
PROBES = [
    ...
    ("GET", "/"),
    ("GET", "/storyboard"),
    ("GET", "/api/v2/storyboard/L.json", {"accept": [200, 404]}),
]
