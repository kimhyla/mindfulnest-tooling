...
CODE_PARITY_PATHS = (
    ...
    "Production/tools/phase_module_lipsync_delivery.py",
    "Production/tools/lipsync_staging.py",
    "Production/tools/lipsync_public_host.py",
    "Production/tools/credentials_lib/credentials.py",
    "Production/lib/fcntl_compat.py",
    "Production/lib/provider_spend.py",
    "Production/lib/state_repo.py",
    "Production/tools/server_handlers/background.py",
...
REGISTRY_COMPARE_PATHS = (
    ...
    "Production/baseline_image_registry.json",
