# MindfulNest Video Production — Lessons Learned v5
...
**Version:** v5 (merged comprehensive: v1 API failures + v2 working techniques + new storyboard/perspective/cropping lessons + April 13 storyboard-first workflow + animation test results)

**Status:** Ready for production reference. Update as new approaches are tested using MindfulNest's standard naming convention (v5 → v6, etc.).
