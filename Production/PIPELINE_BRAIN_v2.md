# MindfulNest Production Pipeline Brain v2
...
| **Gemini 2.5 Flash Image** [NEW April 12] | Pixar 3D character stills | ~$0.039/img | Via google.genai Python library (gemini-2.5-flash-image model) |
...
| **Kling 3.0** (fallback) [NEW April 12] | Animation (fallback when WaveSpeed unavailable) | ~$0.10/sec | When Seedance is unreachable |
