...
| **phase_a_lipsync_route** — which pipeline generates the Phase A module lipsync MP4 | disk | `PHASE_A_ARLO_LAYERED_ROUTE_V2` (handle_phase_a_lipsync → layered only) | `_handle_phase_a_lipsync_layered` / durable layered jobs | shipped | `TECH_SPEC_PHASE_A_ARLO_LAYERED_DEFAULT_ROUTE_v2.md` |
