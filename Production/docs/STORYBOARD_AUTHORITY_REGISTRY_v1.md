...
| **phase_a_lipsync_route** — which pipeline generates the Phase A module lipsync MP4 | disk | `PHASE_A_PATH_A_ROUTE_V1` (handle_phase_a_lipsync) | `run_phase_a_path_a_lipsync` → visual-review terminal | shipped | `TECH_SPEC_PHASE_A_PATH_A_DEFAULT_ROUTE_v1.md` |
